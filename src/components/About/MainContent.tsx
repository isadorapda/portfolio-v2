...
export function MainContent() {
	return (
		<div className="w-full lg:w-[50vw] text-textBodyMobile leading-bodyMobile font-inter lg:pl-[3vw] lg:pt-[20vh] lg:pb-[5vh] text-contrastPrimaryColor dark:text-darkContrastPrimaryColor flex flex-col gap-[3vh]">
